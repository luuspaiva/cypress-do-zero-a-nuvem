describe("Central de Atendimento ao Cliente TAT", () => {
  ...
  Cypress._.times(5, () => {
    it("Preencher campos obrigatórios e enviar formulário", () => {
      ...
      // Valida que a mensagem de sucesso desaparece após 3 segundos
      cy.tick(3000);
  ...
  it("Erro ao enviar formulário com e-mail errado", () => {
    ...
    // Valida que a mensagem de erro desaparece após 3 segundos
    cy.tick(3000);
  ...
  it("Seleciona um arquivo da pasta", () => {
    ...
    cy.get("#file-upload")
      ...
      .should(($el) => {
        //should recebendo uma função de callback
  ...
  it("exibe e oculta a mensagem de sucesso", () => {
    cy.get(".success")
      .should("exist")
  ...
  it("exibe e oculta a mensagem de erro", () => {
    cy.get(".error")
      .should("exist")
      .should("not.be.visible")
      .invoke("show")
  ...
  it("preenche o campo de área de texto usando o comando invoke para chamar o método value", () => {
    const longText = Cypress._.repeat("teste", 100);
  ...
  //exibe o gato que está com display none na página
  it.only("exibe o gato que está com display none na página", () => { 
    cy.get("#cat")
      .should("not.be.visible")
      .invoke("show")
      .should("be.visible")
